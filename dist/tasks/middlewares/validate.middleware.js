...
var ValidateMiddleware = /** @class */ (function () {
    ...
    ValidateMiddleware.checkForExistence = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var taskId, repository, project, e_1;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, repository.findOne({ id: taskId })];
                case 2:
                    project = _b.sent();
                    if (!project) {
                        return [2 /*return*/, response.send({ status: 404, message: 'Task not found' })];
                    }
                    else {
                        next();
                    }
    ...
    ValidateMiddleware.validateCompletedUpdate = function (request, response, next) {
        var schema = Joi.object({
