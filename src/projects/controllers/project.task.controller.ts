...
export class ProjectTaskController {
    public static getProjectTasks = async (request: Request, response: Response) => {
        try {
            const [projectTasks, total] = await ProjectTaskService.getProjectTasks(request);
            return response.send({ projectTasks, total })
        } catch (e) {
            console.log(e)
